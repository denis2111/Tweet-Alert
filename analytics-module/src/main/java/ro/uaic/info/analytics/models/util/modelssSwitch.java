 ...
 * @generated
 */
public class modelssSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static modelssPackage modelPackage;
	 ...
	 * @generated
	 */
	public modelssSwitch() {
		if (modelPackage == null) {
			modelPackage = modelssPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case modelssPackage.TWEET_IMAGE: {
			TweetImage tweetImage = (TweetImage) theEObject;
			T result = caseTweetImage(tweetImage);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Tweet Image</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Tweet Image</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTweetImage(TweetImage object) {
		return null;
	}
